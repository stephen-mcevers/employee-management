        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <a href="?action=viewPersonalInfo"><i class="fa-solid fa-person"></i>&nbsp;</i>Personal Information</a>
                </li>
                <li>
                    <a href="?action=makeRequest"><i class="fa-solid fa-plane-departure"></i>&nbsp;</i>Request Time Off</a>
                </li>
